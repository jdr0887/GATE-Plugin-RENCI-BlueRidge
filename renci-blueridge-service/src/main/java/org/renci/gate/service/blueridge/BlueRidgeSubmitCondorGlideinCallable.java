...
public class BlueRidgeSubmitCondorGlideinCallable implements Callable<PBSSSHJob> {

    private static final Logger logger = LoggerFactory.getLogger(BlueRidgeSubmitCondorGlideinCallable.class);
    ...
    public BlueRidgeSubmitCondorGlideinCallable() {
        super();
    }
